...
local Window = Rayfield:CreateWindow({
	Name = "Anime Evolutions Simulator Private|Lcopium#1131",
	LoadingTitle = "Loading Lcopium|AES",
	LoadingSubtitle = "by Lcopium",
	ConfigurationSaving = {
		Enabled = true,
        ...
        Discord = {
        	Enabled = true,
        	Invite = "pSnKj9WA3q", -- The Discord invite code, do not include discord.gg/
...
Tab1:CreateToggle({
	...
	CurrentValue = true,
	Flag = "GS_dropscoinsdeath", -- A flag is the identifier for the configuration file, make sure every element has a different flag if you're using configuration saving to ensure no overlaps
...
function autoclick_func()
    spawn(function()
        while autoclick and wait(0.15) do
...
local Tab3 = Window:CreateTab("Auto Defence", 4483362458)


Tab3:CreateSection("Auto Defencing")

local autodefence = {["defence1"] = false, ["defence2"] = false, ["defence3"] = false, ["defence4"] = false}

Tab3:CreateParagraph({Title = "Patched", Content = "No Time to Work on it, will be back in 2 weeks"})


Tab3:CreateParagraph({Title = "Death", Content = "Designed to be used outside of the defense area, go stand under a statue or something :)"})
...
local Tab4 = Window:CreateTab("Auto Special", 4483362458)
Tab4:CreateSection("It be like that")


Tab4:CreateParagraph({Title = "Bosses Patched", Content = "No Time to Work on it, will be back in 2 weeks"})
...
function autoweapon_func()
    while wait(5) and autoweapon do
...
Tab10:CreateLabel("Rest of the stuff by Lcopium#1131")
Tab10:CreateLabel("Discord Link: https://discord.gg/pSnKj9WA3q")
Tab10:CreateButton({
